...
The existing X links for Karim and Poormetheus are already in the "Created by" line — keep those. Just add Discord + GitHub above.
...
2. **Task 2** — Outcome column + persistence (P1, schema migration)
3. **Task 3** — Character creation response fix (P1)
4. **Task 4** — Model identity auto-detect
5. **Task 9** — Leaderboard contrast (quick CSS)
6. **Task 7** — Tracker in primary nav (quick HTML)
7. **Task 6** — Social links footer (quick HTML across pages)
8. **Task 8** — Theater schedule cleanup
9. **Task 5** — Outcome badges on frontend (depends on Task 2)
10. **Task 10** — Benchmark layout + preview data
11. **Task 11** — Narrations on session cards
12. **Task 12** — Template copy cleanup
13. **Task 13** — Docs updates
...
- [ ] Footer on all pages has Discord + GitHub links
